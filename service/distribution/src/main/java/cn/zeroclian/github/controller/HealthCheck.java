...
public class HealthCheck {
    ...
    /**
     * 健康检查接口
     * 127.0.0.1：7002/coupon-distribution/health
     */
    @GetMapping("/health")
    public String health(){
        log.debug("view health api");
        return "CouponDistribution is OK!";
    }

    /**
     * 异常测试接口
     * 127.0.0.1:7002/coupon-distribution/exception
     * */
    @GetMapping("/exception")
    public String exception() throws CouponException{
        log.debug("view exception api");
        throw new CouponException("CouponDistribution has some problem");
    }

    /**
     * 获取 Eureka Server 上的微服务元信息
     * 127.0.0.1:7002/coupon-distribution/info
     * */
    @GetMapping("/info")
