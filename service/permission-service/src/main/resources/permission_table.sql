-- 创建路径信息表
CREATE TABLE IF NOT EXISTS `cloud_coupon_data`.`coupon_path` (
...
-- 创建用户角色表
CREATE TABLE IF NOT EXISTS `cloud_coupon_data`.`coupon_role` (
...
CREATE TABLE IF NOT EXISTS `cloud_coupon_data`.`coupon_role_path_mapping` (
...
CREATE TABLE IF NOT EXISTS `cloud_coupon_data`.`coupon_user_role_mapping` (
